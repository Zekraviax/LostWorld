...
void ACardFunctions_NormalPunch::RunCardAbilityFunction(FStackEntry StackEntry)
{
	...
	int32 DamageValue = StackEntry.Card.Controller->EntityBaseData.CoreStats.Strength;

	StackEntry.Card.CurrentTargets[0]->Event_DamageIncoming(DamageValue, StackEntry.Card.Elements[0], E_Card_DamageTypes::E_Physical);
}